 ...
 */
    ...
    public function register_prefilter($function)
    {
        ...
        $this->_plugins['prefilter'][$_name] = [$function, null, null, false];
    }
    ...
    {
        $_name = (is_array($function)) ? $function[1] : $function;
        $this->_plugins['postfilter'][$_name] = [$function, null, null, false];
    }
    ...
    {
        $_name = (is_array($function)) ? $function[1] : $function;
        $this->_plugins['outputfilter'][$_name] = [$function, null, null, false];
    }
