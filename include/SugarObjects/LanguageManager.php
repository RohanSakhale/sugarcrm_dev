...
class LanguageManager
{
     ...
     */
    public function createLanguageFile($module, $templates = ['default'], $refresh = false)
    {
     ...
     */
    public function loadTemplateLanguage($module, $templates, $lang, $loaded_mod_strings)
    {
    ...
    public function addTemplate($module, $lang, $template)
    {
        if ('default' == $template) {
            $template = 'basic';
        }
     ...
     */
    public function clearLanguageCache($module_dir = '', $lang = '')
    {
        if (empty($lang)) {
     ...
     */
    public function _clearCache($module_dir = '', $lang)
    {
     ...
     */
    public function refreshLanguage($module, $lang, $loaded_mod_strings = [], $additional_search_paths = null)
    {
