...
class SchedulersJob extends Basic
{
    ...
    public function fireUrl($job, $timeout = 30)
    {
        ...
        if (false !== $result && $cInfo['http_code'] < 400) {
    ...
    public function resolveJob($resolution, $message = null)
    {
        ...
        if (self::JOB_FAILURE == $resolution) {
            $this->failure_count++;
        ...
        $this->save();
        if (self::JOB_STATUS_DONE == $this->status && self::JOB_SUCCESS == $this->resolution) {
    ...
    public static function runJobId($id, $client)
    {
        ...
        if (self::JOB_STATUS_RUNNING != $job->status) {
    ...
    public function runJob()
    {
        ...
        if ('function' == $exJob[0]) {
            ...
            $this->restoreJobUser();
            if (self::JOB_STATUS_RUNNING == $this->status) {
                ...
                return self::JOB_FAILURE != $this->resolution;
            }
        } elseif ('url' == $exJob[0]) {
