...
class MBLanguage
{
    ...
    {
        $language .= '.lang.php';
        if (!empty($this->strings[$language]) && 'en_us.lang.php' != $language) {
    ...
    {
        $language .= '.lang.php';
        if (!empty($this->appListStrings[$language]) && 'en_us.lang.php' != $language) {
    ...
    public function generateAppStrings($buildFromTemplate = true)
    {
        ...
        $this->appListStrings[$GLOBALS['current_language'] . ".lang.php"] = [];
    ...
    public function getGlobalAppListStringsForMB(&$values)
    {
        ...
        if (!empty($_REQUEST['view_package']) && !empty($_REQUEST['type']) && 'enum' == $_REQUEST['type'] && !empty($_REQUEST['options'])) {
