...
class CampaignLog extends SugarBean
{
    ...
    public function get_list_view_data()
    {
        ...
        if ('Accounts' == $temp_array['TARGET_TYPE']) {
    ...
    public function get_related_name($related_id, $related_type)
    {
        global $locale;
        $db = DBManagerFactory::getInstance();
        if ('Emails' == $related_type) {
        ...
        if ('CampaignTrackers' == $related_type) {
