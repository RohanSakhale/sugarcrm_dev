...
class aCase extends Basic
{
    ...
    public $additional_column_fields = ['bug_id', 'assigned_user_name', 'assigned_user_id', 'contact_id', 'task_id', 'note_id', 'meeting_id', 'call_id', 'email_id'];

    public $relationship_fields = ['account_id' => 'accounts', 'bug_id' => 'bugs',
