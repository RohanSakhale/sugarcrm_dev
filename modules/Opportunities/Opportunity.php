...
class Opportunity extends SugarBean
{
    ...
    public $additional_column_fields = ['assigned_user_name', 'assigned_user_id', 'account_name', 'account_id', 'contact_id', 'task_id', 'note_id', 'meeting_id', 'call_id', 'email_id',
    ];

    public $relationship_fields = ['task_id' => 'tasks', 'note_id' => 'notes', 'account_id' => 'accounts',
    ...
    {
        if (true == $this->force_load_details) {
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if (!empty($this->currency_id)) {
            ...
            if ($currency->id != $this->currency_id || 1 == $currency->deleted) {
    ...
    public function get_contacts()
    {
        ...
        $temp = ['id', 'first_name', 'last_name', 'title', 'email1', 'phone_work', 'opportunity_role', 'opportunity_rel_id'];
