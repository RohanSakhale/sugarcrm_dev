...
class Account extends Company
{
    ...
    public $relationship_fields = ['opportunity_id' => 'opportunities', 'bug_id' => 'bugs', 'case_id' => 'cases',
    ...
    public function __construct()
    {
        ...
        //Email logic
        if (!empty($_REQUEST['parent_id']) && !empty($_REQUEST['parent_type']) && 'Emails' == $_REQUEST['parent_type'] && !empty($_REQUEST['return_module']) && 'Emails' == $_REQUEST['return_module']) {
