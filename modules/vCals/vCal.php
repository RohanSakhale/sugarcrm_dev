...
class vCal extends SugarBean
{
    ...
    public function get_vcal_freebusy($user_focus, $cached = true)
    {
        ...
        global $sugar_config;
        $timeOffset = 2;
        if (isset($sugar_config['vcal_time']) && 0 != $sugar_config['vcal_time'] && $sugar_config['vcal_time'] < 13) {
    ...
    // static function:
    // cache vcals
    public function cache_sugar_vcal(&$user_focus)
    {
    ...
    public function cache_sugar_vcal_freebusy(&$user_focus)
    {
        $focus = new vCal();
