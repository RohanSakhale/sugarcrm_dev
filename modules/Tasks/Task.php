...
//bug 28138 todo
    ...
    public function get_list_view_data()
    {
        ...
        if (!empty($_REQUEST['module']) && 'Calendar' != $_REQUEST['module'] && 'Tasks' != $_REQUEST['module'] && 'Home' != $_REQUEST['module']) {
        ...
        if ("Completed" != $this->status && "Deferred" != $this->status) {
