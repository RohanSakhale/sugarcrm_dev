...
class SugarAuthenticate
{
    ...
    public function sessionAuthenticate()
    {
        ...
        if (isset($action) && isset($module) && "Authenticate" == $action && "Users" == $module) {
        ...
        if ($authenticated && ((empty($_REQUEST['module']) || empty($_REQUEST['action'])) || ('Users' != $_REQUEST['module'] || 'Logout' != $_REQUEST['action']))) {
            $this->validateIP();
        }
    ...
    public function validateIP()
    {
        ...
        if (!isset($sugar_config['verify_client_ip']) || true == $sugar_config['verify_client_ip']) {
