...
class Contact extends Person
{
    ...
    public $relationship_fields = ['account_id' => 'accounts', 'bug_id' => 'bugs', 'call_id' => 'calls', 'case_id' => 'cases', 'email_id' => 'emails',
    ...
    public function create_new_list_query($order_by, $where, $filter = [], $params = [], $show_deleted = 0, $join_type = '', $return_array = false, $parentbean = null, $singleSelect = false)
    {
        ...
        if (isset($_REQUEST['action']) && 'ContactAddressPopup' == $_REQUEST['action']) {
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if (!empty($this->portal_active) && 1 == $this->portal_active) {
