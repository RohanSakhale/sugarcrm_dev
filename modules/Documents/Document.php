...
class Document extends SugarBean
{
    ...
    public function save($check_notify = false)
    {
        ...
        if (empty($this->id) || $this->new_with_id) {
            ...
            if (isset($_REQUEST) && isset($_REQUEST['duplicateSave']) && true == $_REQUEST['duplicateSave'] && isset($_REQUEST['filename_old_doctype'])) {
            ...
            if (!empty($_FILES['filename_file'])) {
                ...
                $createRevision = true;
            } else if ($isDuplicate && (empty($this->doc_type) || 'Sugar' == $this->doc_type)) {
            ...
            if (!empty($this->doc_id) && 'Sugar' != $this->doc_type) {
                $createRevision = true;
            }
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if ($this->ACLAccess('DetailView')) {
            if (!empty($this->doc_type) && 'Sugar' != $this->doc_type && !empty($this->doc_url)) {
